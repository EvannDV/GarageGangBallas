...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "evGangG", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "evGangG", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "evGangG", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
